...
I am especially interested in backend systems where LLMs are not treated as magic boxes, but as components inside safe, testable, and debuggable workflows.
